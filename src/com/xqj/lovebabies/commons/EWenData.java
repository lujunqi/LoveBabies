...
public class EWenData implements Parcelable{
	...
	public static final Parcelable.Creator<EWenData> CREATOR = new Parcelable.Creator<EWenData>() {
		public EWenData createFromParcel(Parcel in) {
			return new EWenData(in);
		}

		public EWenData[] newArray(int size) {
			return new EWenData[size];
		}
	};

	private EWenData(Parcel in) {
		head  = in.readInt();
		dataone = in.readInt();
		datatwo = in.readInt();
		three = in.readInt();
