...
public class thread_common_upload_files extends Thread {
	...
	public thread_common_upload_files(Handler handler, interface_app_upload_file_req req) {
	...
	public void run() {
		try {
			resp = network.ios_interface_app_upload_file(req);
