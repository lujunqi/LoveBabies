...
public class ActivityViewNoticePhoto extends Activity {
	...
	private NoticeViewGroupPaperAdapter pagerAdapter = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pagerAdapter = new NoticeViewGroupPaperAdapter();
...
//		});
	...
	private void f_display_Image(ImageView imageView, String pic_path){
		...
		System.out.println("公告图片NoticePhoto-->"+imgurl);
...
//		ImageLoader.getInstance().displayImage(imgurl, imageView, options);
		utils_common_tools.f_display_Image(ActivityViewNoticePhoto.this, 
				imageView, imgurl,R.drawable.default_image_position,
				R.drawable.default_image_position, ImageScaleType.IN_SAMPLE_INT);
	}

	class NoticeViewGroupPaperAdapter extends PagerAdapter{
		@Override
		public int getCount() {
			// TODO Auto-generated method stub
		...
		public Object instantiateItem(View container, int position) {
            ...
            view_list.get(position).setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					System.out.println("growth_photo_layout onclick................");
					ActivityViewNoticePhoto.this.finish();
				}
			});
