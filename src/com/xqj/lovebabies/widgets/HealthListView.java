...
/**
 * 健康育儿主页，添加ViewPager到ListView头部后，ViewPager的滑动更流畅
 * 增加下拉刷新功能
 * @author sunshine
 */
...
//	private int scrollDirection = 0;//滑动方向：1、竖向           2、横向
	...
	public HealthListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		// 如果是横向滑动的时候，不响应事件,
		//以防止在滑动ViewPage的时候，ListView上下滑动,影响体验
//		System.out.println("scrollDirection-->"+scrollDirection);
//		System.out.println("MotionEvent.ACTION-->"+event.getAction());
//		System.out.println("MotionEvent.ACTION_MOVE-->"+MotionEvent.ACTION_MOVE);

//		if(scrollDirection==2 && event.getAction()==MotionEvent.ACTION_MOVE){
//			System.out.println("横向滑动,不响应事件");
//	    	return false;
//	    }
		if (isRefreshable) {
...
//				scrollDirection = 0;//重置回去
	...
	public void onRefreshComplete() {
		state = DONE;
		lastUpdatedTextView.setText("最近更新:" + utils_common_tools.getFormatDate(new Date(), "MM-dd HH:mm"));
		changeHeaderViewByState();
	}
