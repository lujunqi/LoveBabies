...
import com.xqj.lovebabies.structures.fragment_zsabb_health_item;
...
public class adapter_fragment_zsabb_health_listview extends BaseAdapter {
	private fragment_zsabb_health_item item = null;
	private table_health_information health_info = null;
	private LayoutInflater inflater = null;
	private Vector<table_health_information> list_health = null;
	private Context context = null;
	
	public adapter_fragment_zsabb_health_listview(Context context){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView = inflater.inflate(R.layout.fragment_zsabb_health_item, parent, false);
			item = new fragment_zsabb_health_item();
			TextView textview_health_title = (TextView)convertView.findViewById(R.id.health_title_textview);;
			TextView textview_from_title = (TextView)convertView.findViewById(R.id.health_from_textview);;
			...
			item.setTextview_from_title(textview_from_title);
			convertView.setTag(item);
		}else{
			item = (fragment_zsabb_health_item)convertView.getTag();
		}
		
		item.getTextview_health_title().setText(health_info.getTitle());
		item.getTextview_from_title().setText("来自"+health_info.getSource()+" "+health_info.getPublish_time());
